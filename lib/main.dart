  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        body: Center(
          child: CustomPaint(
            painter: CustomShapeBackgrond(color: Colors.black38),
            child: Container(
              height: 120,
              width: 350,
...
class CustomShapeBackgrond extends CustomPainter {
  const CustomShapeBackgrond({
    this.color,
    this.text1,
    this.textStyle1,
    this.text2,
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final textSpan2 = TextSpan(
      text: text2 ??
          'Description Sales Partner with marketing skills in Pune, with marketing skills in Pune. Test Data gather',
